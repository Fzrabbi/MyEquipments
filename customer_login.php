      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#"> <?php  if (isset($_SESSION['email'])) : ?>
			<li>Welcome <strong><?php echo $customer_email; ?> </strong></li>
			<a href="customer.php?logout='1'"style="color:red;">logout</a> 
		<?php endif ?> </a>
            </li>
			...
			<div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
				...
				//$url='?'.'id='.$id;
				 ...
				 echo "<td><a href=\"order.php?pro_id=$row[product_id]&customer_email=$customer_email\" onClick=\"return confirm('Are you sure you want to Order this product ?')\">Order</a></td>";
				?>
              </div> 
            </div>
						 <?php
